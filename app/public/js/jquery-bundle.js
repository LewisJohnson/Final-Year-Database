...
|--------------------------------------------------------------------------
|
| A function extracted from jQuery mobile.
|
*/
...
;(function ($) {
	// Default options
	var defaults = {
		duration: config.tapHeldTime, // ms
		clickHandler: null
	...
	var taphold = $.event.special.taphold = {
		setup: function setup(data) {
			$(this).bind(touchSupported ? "touchstart" : "mousedown", data, startHandler).bind(touchSupported ? "touchend" : "mouseup", stopHandler).bind(touchSupported ? "touchmove touchcancel" : "mouseleave", leaveHandler);
		},
		teardown: function teardown(namespaces) {
			$(this).unbind(touchSupported ? "touchstart" : "mousedown", startHandler).unbind(touchSupported ? "touchend" : "mouseup", stopHandler).unbind(touchSupported ? "touchmove touchcancel" : "mouseleave", leaveHandler);
		}
	};
})(jQuery);
