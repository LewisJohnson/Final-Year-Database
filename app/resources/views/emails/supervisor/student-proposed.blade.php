...
<p>Please <a href="{{ action('Auth\LoginController@showLoginForm', ['educationLevel' => Session::get('education_level')['shortName'], 'department' => Session::get('department')]) }}">Log In</a> to accept or reject {{ $student->user->first_name }}.</p>
