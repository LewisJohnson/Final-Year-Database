<form id="TransactionsSearchForm" class="form d-flex pb-4 mt-3" action="{{ action('TransactionController@index') }}" role="form" method="GET" accept-charset="utf-8">
	{{ csrf_field() }}
	<div class="search-container w-100 d-flex flex-wrap shadow-sm">
		<input class="search-input form-control w-auto flex-grow-1" type="text" minlength="3" name="transactionSearchTerm" placeholder="Search transactions..." value="{{ Request::get("transactionSearchTerm") }}">
