@if($project->skills == 'Temporary')
	<p>
		You have been assigned a temporary project by the Project Administrator.<br>
		This is nothing to worry about, it's just needed in the backend to assign you a marker.<br><br>

		You will not be able to select or propose a project until this process is complete.
	</p>
@else 
