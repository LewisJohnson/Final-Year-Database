...
/**
 * The email sent to the supervisor when a student proposes a project to them.
 */
class StudentProposed extends Mailable{
	...
	public function build(){
		return $this->view('emails.supervisor.student-proposed')->with([
